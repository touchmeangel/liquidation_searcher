...
use crate::marginfi::types::helpers::{boxed_price_serde, current_result_serde};
...
pub fn load_price_update_v2_checked(account: &solana_account::Account) -> MarginfiResult<PriceUpdateV2> {
  load_price_update_v2_checked_data(&account.data)
}

pub fn load_price_update_v2_checked_data(price_feed_data: &[u8]) -> MarginfiResult<PriceUpdateV2> {
...
pub struct LitePullFeedAccountData {
  #[serde(with = "current_result_serde")]
