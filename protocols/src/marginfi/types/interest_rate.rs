...
#[repr(C)]
#[derive(Serialize, Deserialize, Debug, PartialEq, Eq, Copy, Clone, Pod, Zeroable, Default)]
...
#[derive(Serialize, Deserialize, Clone, Copy, Default, Zeroable, Pod, Debug, PartialEq, Eq)]
#[repr(C)]
